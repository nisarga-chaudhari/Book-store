...
router.post('/addcategory',(req,res,next)=>{
    ...
    //console.log(req.body)
    adminModel.addcategory(collection_name,req.body).then((result)=>{
        res.json(result)
    }).catch((err)=>{
        console.log(err)
    })
...
router.get('/fetchbooktype',(req,res,next)=>{
    collection_name='category'
    adminModel.fetchbooktype(collection_name).then((result)=>{
        res.send(result)
    }).catch((err)=>{
        res.send('fail')
    })
...
router.post('/deletebook',(req,res,next)=>{
    var collection_name="product"
    adminModel.deletebook(collection_name,req.body).then((result)=>{
        res.json(result)        
    }).catch((err)=>{
        console.log(err)
    })    
